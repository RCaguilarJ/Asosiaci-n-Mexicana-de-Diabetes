...
try {
    ...
    // Si se está llamando desde API, devolver JSON
...
/**
 * Crea (y reutiliza) una conexión PDO hacia la base remota del sistema médico.
 * Devuelve null cuando no hay credenciales configuradas o la conexión falla.
 */
