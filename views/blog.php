<?php
    ...
    $imagenPorDefecto = 'assets/img/platilloSano.jpg';
    ...
    function obtenerContenidoRemoto($url) {
        if (function_exists('curl_init')) {
            ...
            curl_setopt_array($ch, [
                ...
                CURLOPT_TIMEOUT => 8,
                CURLOPT_USERAGENT => 'AMD-Jalisco/1.0 (+https://diabetesjalisco.org)'
            ]);
            $data = curl_exec($ch);
            $error = curl_errno($ch);
            curl_close($ch);
        ...
        <div class="blog-hero-inner">
            ...
            <div class="blog-hero__figure">
                <div class="hero-illustration">
                    <img src="assets/img/medidorInsulina.jpg" alt="Personas aprendiendo sobre diabetes">
                </div>
            </div>
        </div>
    </section>
